                    ...
                    <div className="detail-content-1">
                        ...
                        <div className="detail-content-1-2">
                            <div>
                                ...
                                <input value="DT_001" id="DT_001"></input>
                            </div>
                            <div>
                                <label htmlFor="HSMT_001">Mã HSMT</label>
                                <input value="HSMT_001" id="HSMT_001"></input>
                            </div>
                        </div>
                        <div className="detail-content-1-3">
                            <label htmlFor="mua-sam-an-uong">Tên gói thầu</label>
                            <input value="Gói thầu mua sắm laptop" type="select" id="mua-sam-an-uong"></input>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div className="detail-ben-moi-thau">
                                        ...
                                        <div className="dien-thoai-ben-mt">
                                            ...
                                            <input id="dien-thoai-ben-mt" placeholder="Hiển thị theo thông tin HSMT"></input>
                                        </div>
                                        <div className="fax-ben-mt">
                                            <label htmlFor="fax-ben-mt">Fax</label>
                                            <input id="fax-ben-mt" placeholder="Hiển thị theo thông tin HSMT"></input>
                                        </div>
                                        <div className="detail-ms-thue-ben-mt">
                                            <label htmlFor="ms-thue-ben-mt">Mã số thuế</label>
                                            <input id="ms-thue-ben-mt" placeholder="Hiển thị theo thông tin HSMT"></input>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="detail-dd-phat-hanh-hsmt">
                                        ...
                                        <div className="detail-dt-pt">
                                            ...
                                            <input id="dt-pt" placeholder="Hiển thị theo thông tin HSMT"></input>
                                        </div>
                                        <div className="detail-fax-pt">
                                            <label htmlFor="fax-pt">Fax</label>
                                            <input id="fax-pt" placeholder="Hiển thị theo thông tin HSMT"></input>
                                        </div>
                                    </div>
                                </div>
                                <div>
